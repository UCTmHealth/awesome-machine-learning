...
* [DSSTNE](https://github.com/amznlabs/amazon-dsstne) - Amazon DSSTNE(Deep Scalable Sparse Tensor Network Engine) is open source software library for training and deploying deep neural networks using GPUs
